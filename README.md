...
The code is C++23 with a dependency on Boost for R-trees in Boost.Geometry and boost::hash_combine, but not other dependencies e.g. I currently serialize to raster files using only stb-image-write.h.
